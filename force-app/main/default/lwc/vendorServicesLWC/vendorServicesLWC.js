...
export default class VendorServicesLWC extends UtilityBaseElement{
    ...
    doInit() {
        ...
        .then(result => {
            ...
            this.programAssignment = this.checkNamespaceApplicable(JSON.parse(result).programAssignment,false) ;
    ...
    handleChange(event) {
        ...
        for(let i=0;i<this.namelist.length;i++) {
            if(this.namelist[i].Id == value) {
                ...
                this.details.clientid = this.namelist[i].Person__r.Casevault_PID__c;
                this.details.DOB = this.namelist[i].Person__r.Date_of_Birth__c;
                this.details.gender = this.namelist[i].Person__r.Gender__c;
                this.details.age = this.namelist[i].Person__r.Age__c;
                this.details.id = this.namelist[i].Id;
                this.details.name = this.namelist[i].Person__r.Name;
                this.details.clientProgram = (this.programAssignment.find(ele => ele.Contact__c == value)).Id;
