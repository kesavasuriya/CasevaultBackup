...
const fields = ['Id', 'Name','Petition_for_Child__r.Name', 'Type_of_Petition__c', 'Name_of_LDSS_Attorney__c'];
    ...
    relateRecords(response) {
        ...
        if (response.data) {
            ...
            for (let i = 0; i < response.data.length; i++) {
                let rec = {};
                rec.Name = response.data[i].Petition_for_Child__r.Name;
