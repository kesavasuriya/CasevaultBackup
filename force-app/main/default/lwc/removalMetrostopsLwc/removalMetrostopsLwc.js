...
import getContentDocumentDetail from '@salesforce/apex/VideoController.getContentDocumentDetail';
import { NavigationMixin } from 'lightning/navigation';

export default class RemovalMetrostopsLwc extends NavigationMixin(UtilityBaseElement) {
    ...
    handleVideo() {
        ...
        getContentDocumentDetail({ docName : 'Child_Removal_Training_Video'})
        .then(result => {
            ...
            if(result) {
                this[NavigationMixin.Navigate]({
                    ...
                    attributes: {
                        url: '/sfc/servlet.shepherd/document/download/'+result
                    }
                });
            }
        }).catch(error =>{
