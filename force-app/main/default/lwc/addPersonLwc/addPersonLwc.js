            ...
            getProviderId({ homeApprovalId: this.recordId })
                .then(result => {
                 ...
                 if(this.intakePurpose && this.objectApiName == 'Case') {
                    this.defaultValue.Intake_Purpose__c = this.intakePurpose;
                 }
    ...
    handleProcced(event) {
        ...
        if(this.objectApiName == 'Case') {
            ...
            .then(result => {
                ...
                // if( result.Origin == 'Adult Protective Services' ) {
                //     this.intakePurpose = result.Origin;
                // } else if( result.Origin == 'Request for services' && result.Service_Program__c == 'Adult Services' ) {
                //     this.intakePurpose = 'Adult Services';
                // }
